...
export const metadata = { title: "Preview B (Warm): クリーム × サンセット | LVN" };
  ...
  return (
    <div style={{ background: PALETTE.bg, color: PALETTE.text }}>
      <div className="px-4 py-2 text-center text-xs font-bold flex flex-wrap items-center justify-center gap-3" style={{ background: PALETTE.dark, color: PALETTE.bg }}>
        <span className="px-2 py-0.5 rounded font-black" style={{ background: PALETTE.accent, color: PALETTE.dark }}>WARM</span>
        クリーム × ブラウン × サンセットオレンジ
      ...
      <section className="relative min-h-[100vh] flex flex-col">
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-[1.2fr_1fr]">
          ...
          <div className="relative hidden lg:block overflow-hidden" style={{ background: PALETTE.dark }}>
            ...
            />
            <div className="absolute inset-0" style={{ background: `linear-gradient(to bottom, transparent 0%, rgba(31,22,18,0.4) 100%)` }} />
      ...
      <section className="relative px-6 md:px-12 py-24 md:py-40 overflow-hidden">
        <p aria-hidden="true" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-black leading-none select-none pointer-events-none whitespace-nowrap" style={{ fontSize: "clamp(14rem, 30vw, 28rem)", color: "rgba(42, 31, 26, 0.05)" }}>
          ONLY ONE
        </p>
      ...
      <section className="px-6 md:px-12 py-20 md:py-28" style={{ background: PALETTE.dark, color: PALETTE.bg }}>
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0" style={{ borderLeft: `1px solid rgba(250,246,238,0.2)` }}>
            {stats.map((s) => (
              <div key={s.num} className="px-5 md:px-7 py-6 md:py-8 group transition-colors hover:bg-white/5" style={{ borderRight: `1px solid rgba(250,246,238,0.2)` }}>
      ...
      <section className="relative h-[80vh] min-h-[500px] overflow-hidden" style={{ background: PALETTE.dark }}>
        <Image
          ...
          style={{ filter: "sepia(0.3)" }}
        />
        <div className="absolute inset-0" style={{ background: `linear-gradient(to right, rgba(31,22,18,0.6) 0%, transparent 60%)` }} />
