      ...
      <section className="bg-white px-6 md:px-10 pt-16 md:pt-24 pb-12 md:pb-16">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-base md:text-lg text-[color:var(--color-text-muted)] max-w-2xl leading-relaxed">
            月 1 回の指導者資格講習会、6 つの活動の体験会・トークセッション。
            <br />
      ...
      <section className="bg-[#FFD647] px-6 md:px-10 py-20 md:py-28 border-t-2 border-black border-b-2">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base md:text-lg leading-relaxed mb-8 max-w-2xl mx-auto">
            指導者資格講習会は毎月 1 回開催。
            「レクリエーションインストラクター」または「スポーツ・レクリエーション指導者」のどちらかの資格取得に向けた単位として認定されます。
          </p>
          <Link
            href="/qualification/"
            className="inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-black text-[#FFD647] font-black hover:scale-105 transition-transform"
          >
